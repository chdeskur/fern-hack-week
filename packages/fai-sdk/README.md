...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Ffern-api%2Ffai-sdk)
[![npm shield](https://img.shields.io/npm/v/@fern-api/fai-sdk)](https://www.npmjs.com/package/@fern-api/fai-sdk)
...
```sh
npm i -s @fern-api/fai-sdk
```

## Reference

A full reference for this library is available [here](https://github.com/fern-api/fai-sdk/blob/HEAD/./reference.md).
...
const client = new FernFaiClient({
    ...
