...
async function copyModules(destPath) {
  ...
  try {
    if (isWindows) {
      await execAsync(`copy node_modules/.pnpm/esbuild@0.25.0 ${destPath}\\ && copy node_modules/.pnpm/@esbuild+* ${destPath}\\`);
    } else {
      await execAsync(`cp -r node_modules/.pnpm/esbuild@0.25.0 node_modules/.pnpm/@esbuild+* ${destPath}/`);
    }
  } catch (error) {
