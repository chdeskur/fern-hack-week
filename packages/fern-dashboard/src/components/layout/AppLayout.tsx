  ...
  return (
    <div className="dark:bg-gray-1200 flex min-w-0 flex-1 flex-col bg-gray-300">
      ...
      <div className="flex min-h-0 flex-1 flex-col md:flex-row-reverse">
        <div className="dark:border-gray-1100 flex flex-1 justify-center overflow-y-auto border-x border-t border-gray-500 bg-white px-12 pt-12 md:mr-4 md:rounded-t-2xl dark:bg-black">
