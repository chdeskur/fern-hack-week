...
interface ConversationsDataTableHeaderProps<TData> {
  table: Table<TData>;
}

export function ConversationsDataTableHeader<TData>({
  table,
}: ConversationsDataTableHeaderProps<TData>) {
  return (
    <div className="mb-4 flex items-center justify-between">
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Search..."
          value={
            (table.getColumn("firstUserMessage")?.getFilterValue() as string) ??
            ""
          }
          onChange={(event) =>
            table
