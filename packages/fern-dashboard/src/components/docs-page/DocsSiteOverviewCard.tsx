...
export function DocsSiteOverviewCard({ docsUrl }: DocsSiteOverviewCard.Props) {
  ...
  return (
    <div className="dark:bg-gray-1200 flex min-w-0 flex-1 flex-col gap-6 rounded-xl border border-gray-500 bg-gray-100 p-3 sm:p-4 md:flex-row md:p-5 lg:p-6 dark:border-gray-900">
      {docsSite != null ? (
